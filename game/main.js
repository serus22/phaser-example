jQuery(document).ready(function($){
  ...
  var numVeggies = Math.floor(Math.random() * 200);
  ...
  function update() {
    ...
    if(numVeggies === 0 && ! this.showedAlert) {
    ...
    if (cursors.left.isDown && sprite.body.position.x > 0)
    {
      sprite.body.velocity.x = -300;
    }
    else if (cursors.right.isDown && sprite.body.position.x + sprite.body.width < WIDTH)
    {
      sprite.body.velocity.x = 300;
    }
